...
Write-Host "Update do repositório do msys2"
Start-Process -Wait -FilePath C:\msys64\msys2_shell.cmd -ArgumentList "-defterm -no-start -mingw64 -here -c 'pacman --noconfirm -Suy'"
